...
studies <- read.table("general/other_placenta_studies.tsv", header = TRUE, sep = "\t")
...
sdrf = str_replace(sdrf, 'Derived Array Data File', 'Array Data File')
...
# GSE60438_non_normalized_HT12v4.txt
# GSE44711_non-normalized_data.txt
# GSE30186_non_normalized.txt
x.lumi <- lumiR(paste(current_path, "GSE30186_non_normalized.txt", sep="/"),
