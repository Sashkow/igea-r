...
# igea[igea$arraydatafile_exprscolumnnames=="GSM871046_sample_table.txt",]
# setdiff(colnames(mrgd), pdata$arraydatafile_exprscolumnnames)
...
unique(pdata$Biological.Specimen)
...
# ncol(mrgd)
# nrow(pdata)
# nrow(pdata[which(pdata$Diagnosis == "Healthy"),])
